...
3) Install pyGame into your virtual enviornment or install it globally
4) Run the main.py file.

This is what you will see:

<img width="749" alt="SS-1" src="https://github.com/kaleem-Durrani/Finite-Automata-Simulator/assets/160228066/75e4f202-8ca2-49b6-a085-4765dd7cab76">
...
After adding states you can drag and drop them with the left mouse button by clicking and dragging.

Add some states and drag them arround.

<img width="749" alt="SS-2" src="https://github.com/kaleem-Durrani/Finite-Automata-Simulator/assets/160228066/0a218921-ff1b-4b19-99f6-fde1f9ae7d9c">



Now the important part is to set the transitions from each state to another on an input (this script currently works on 2 inputs 'a' and 'b').
...
3) Hover the cursor over the target state and press the middle mouse button to set the transition.
4) Transition for input 'a' will be shown with red arrows and transitions for input b will be shown with purple arrows

<img width="749" alt="SS-3" src="https://github.com/kaleem-Durrani/Finite-Automata-Simulator/assets/160228066/9bf95db7-eef9-4da5-a902-8330fa4ed8be">



Now to set End states and Dead Ends

1) Select the desired state by pressing the left and right arrow keys (selected state is shown in the top left corner)
2) To set a state to an End State press 'w' key on keyboard to to return it to a normal state press 'w' again
3) To set a state to a Dead End press 'q' key on keyboard to return it to a normal state press 'q' again

<img width="749" alt="Screenshot 2024-04-21 124831" src="https://github.com/kaleem-Durrani/Finite-Automata-Simulator/assets/160228066/5cf0444b-25e0-40de-9d8f-32a3d8f1420f">



To test an input on the example of the state machine you have designed,

1) Enter the input you want to test, into the black box at the bottom left of the screen (it will only accept 'a' and 'b' )
...
<img width="270" alt="Screenshot 2024-04-21 125859" src="https://github.com/kaleem-Durrani/Finite-Automata-Simulator/assets/160228066/b9090fdf-c383-408e-a29c-3820b825ea9c">
